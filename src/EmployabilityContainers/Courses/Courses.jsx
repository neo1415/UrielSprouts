  ...
  return (
    <div id='courses' className='courses-container'>
        ...
        <div className='coursesTitle'>
            ...
            <p className='courseTitle-p'>Depending on your preference, we offer two types of UJRT Pathways, 
        ...
        <div className='course-Container'>
            <div className='basic'>
                ...
                transition={{duration:1,ease:'easeInOut'}}
                 ...
                 className='Image'>
                    <img src={images.basic} alt='basic ' className='basic-img' />
                </motion.div>
                <motion.div 
                       whileInView={{x: [300, 0]}}
                ...
                className='course-detail'>
                    ...
                    <p className='course-p'>The BASIC course will focus on workplace skills and knowledge, 
            ...
            transition={{duration:1,ease:'easeInOut'}}
                  className='Image'>
                    <img src={images.executive} alt='executive' className='basic-img' />
                </motion.div>
                <motion.div 
                 whileInView={{x: [-300, 0]}}
                    transition= {{ duration:0.85, ease:'easeOut' }}
                className='course-detail'>
                   ...
                   <h4>The Second Pathway <span>(Executive)</span> is <span>10 hours</span> of <span>virtual training</span> over <span>5 days</span></h4> 
                    ...
                    <div className='course-description'>
                   <p className='course-p'> The Executive course will help you develop (build) your resume and improve interview techniques (providing free consultation),
