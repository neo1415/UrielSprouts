...
<Link to='/#homepage ' className='logo'><img src={images.logo} className='nav-logo' /> </Link>
  ...
  <ol>
    ...
    <a href="#services">Services</a>
      <ol className="sub-menu">
        ...
        <li className="menu-item"><Link to="/hospitality" >Hospitality</Link></li>
      </ol>
    </li>
    <li className="menu-item">
  ...
  <div className='app__navbar-menu'>
    ...
    <details className="faq__detail drop-container">
          ...
          <Link to='/hospitality' className="faq__text drop-link" onClick={() => setToggle(false)}>Hospitality</Link>
        </details> 
    </li>
    <li className="menu-item" >
